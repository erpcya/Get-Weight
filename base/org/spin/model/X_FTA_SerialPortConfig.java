...
public class X_FTA_SerialPortConfig extends PO implements I_FTA_SerialPortConfig, I_Persistent 
{
    ...
    {
      super (ctx, FTA_SerialPortConfig_ID, trxName);
      /** if (FTA_SerialPortConfig_ID == 0)
        {
			setBauds (null);
// 9600
			setDataBits (null);
...
// 1
    ...
    /** Load Constructor */
    public X_FTA_SerialPortConfig (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_FTA_SerialPortConfig[")
	...
	public void setFTA_SerialPortConfig_ID (int FTA_SerialPortConfig_ID)
	{
		if (FTA_SerialPortConfig_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_FTA_SerialPortConfig_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_FTA_SerialPortConfig_ID, Integer.valueOf(FTA_SerialPortConfig_ID));
	}
